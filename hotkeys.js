/* videojs-hotkeys v0.2.20 - https://github.com/ctd1500/videojs-hotkeys */ ! function(e, t) {
    "function" == typeof define && define.amd ? define("videojs-hotkeys", ["video.js"],
        function(e) {
    ...
    function(e) {
        ...
        (e.registerPlugin || e.plugin)("hotkeys",
            function(t) {
                var r = this,
                    n = r.el(),
                    o = document,
                ...
                n.hasAttribute("tabIndex") || n.setAttribute("tabIndex", "-1"),
                    n.style.outline = "none", !v && r.autoplay() || b || r.one("play", function() {
                        n.focus()
                    }), p && r.on("userinactive",
                        function() {
                            var e = function() {
                ...
                return r.on("keydown", function(e) {
                    ...
                    if (r.controls()) {
                        var t = e.relatedTarget || e.toElement || o.activeElement;
                        t != n && t != n.querySelector(".vjs-tech") && t != n.querySelector(".iframeblocker") || m && (r.isFullscreen() ? r.exitFullscreen() : r.requestFullscreen() , u && r.play())
                    }
